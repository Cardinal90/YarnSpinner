...
public interface IYarnSpinnerParserListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterVariable_declaration([NotNull] YarnSpinnerParser.Variable_declarationContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="YarnSpinnerParser.variable_declaration"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitVariable_declaration([NotNull] YarnSpinnerParser.Variable_declarationContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterCsharp_code_content([NotNull] YarnSpinnerParser.Csharp_code_contentContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="YarnSpinnerParser.csharp_code_content"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitCsharp_code_content([NotNull] YarnSpinnerParser.Csharp_code_contentContext context);
	/// <summary>
	/// Enter a parse tree produced by <see cref="YarnSpinnerParser.csharp_code_block"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterCsharp_code_block([NotNull] YarnSpinnerParser.Csharp_code_blockContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="YarnSpinnerParser.csharp_code_block"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitCsharp_code_block([NotNull] YarnSpinnerParser.Csharp_code_blockContext context);
	/// <summary>
	/// Enter a parse tree produced by <see cref="YarnSpinnerParser.csharp_condition_block"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterCsharp_condition_block([NotNull] YarnSpinnerParser.Csharp_condition_blockContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="YarnSpinnerParser.csharp_condition_block"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitCsharp_condition_block([NotNull] YarnSpinnerParser.Csharp_condition_blockContext context);
}
} // namespace Yarn.Compiler
