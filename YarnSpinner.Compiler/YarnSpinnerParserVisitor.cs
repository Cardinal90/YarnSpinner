...
public interface IYarnSpinnerParserVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitVariable_declaration([NotNull] YarnSpinnerParser.Variable_declarationContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitCsharp_code_content([NotNull] YarnSpinnerParser.Csharp_code_contentContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="YarnSpinnerParser.csharp_code_block"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitCsharp_code_block([NotNull] YarnSpinnerParser.Csharp_code_blockContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="YarnSpinnerParser.csharp_condition_block"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitCsharp_condition_block([NotNull] YarnSpinnerParser.Csharp_condition_blockContext context);
}
} // namespace Yarn.Compiler
